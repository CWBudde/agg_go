...
func newCPPBackendContextAvailable(int, int) (Context, error) { return nil, cppUnavailableError(cppUnavailableReason()) }

func newCPPBackendContextForImageAvailable(Image) (Context, error) {
	return nil, cppUnavailableError(cppUnavailableReason())
}

func newCPPBackendImageAvailable(int, int) (Image, error) { return nil, cppUnavailableError(cppUnavailableReason()) }
